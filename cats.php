 ...
 <!-- Mirrored from preview.colorlib.com/theme/animalshelter/cats.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 21:45:49 GMT -->
     ...
     <div class="container">
       <div class="row d-flex align-items-center justify-content-center">
         <div class="about-content col-lg-12">
           ...
           <p class="text-white link-nav"><a href="index-2.html">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="cats.html"> Gatos</a></p>
         </div>
       </div>
     </div>
   </section>
       ...
       <div class="row">
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct1.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
               <li><a href="form_adocao.php">ADOTE</a></li>
             </div>
           </div>
         </div>
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct2.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
             </div>
           </div>
         ...
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct3.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
             </div>
           </div>
         ...
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct4.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
             </div>
           </div>
         ...
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct5.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
             </div>
           </div>
         ...
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct6.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
             </div>
           </div>
         ...
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct7.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
             </div>
           </div>
         ...
         <div class="col-lg-3 col-md-6">
           <div class="single-cat-list">
             <img src="https://preview.colorlib.com/theme/animalshelter/img/ct8.jpg" alt="" class="img-fluid">
             <div class="overlay">
               <div class="text">Siamese Cat</div>
             </div>
           </div>
           ...
           <div class="single-footer-widget mail-chimp">
             ...
             <ul class="list-contact">
               ...
               <li class="flex-row d-flex">
                 ...
                 <div class="detail">
                   <h4><a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c7b4b2b7b7a8b5b387a4a8aba8b5abaea5e9a4a8aa">[email&#160;protected]</a></h4>
                   <p>
